...
export function AutoConnectDb():Promise<string>;

export function CheckAdbConnection(arg1:string):Promise<string>;
...
export function ExportPlayerTeam(arg1:string,arg2:string,arg3:string):Promise<string>;
