...
export function AutoConnectDb() {
  return window['go']['main']['App']['AutoConnectDb']();
}

export function CheckAdbConnection(arg1) {
  return window['go']['main']['App']['CheckAdbConnection'](arg1);
}
...
export function ExportPlayerTeam(arg1, arg2, arg3) {
  return window['go']['main']['App']['ExportPlayerTeam'](arg1, arg2, arg3);
}

export function ExportTeamUser() {
