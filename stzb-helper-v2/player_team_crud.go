...
func (a *App) HidePlayerTeam(sourceType string, sourceID int, role string) string {
	if model.Conn == nil {
		return global.Response{Message: "请先选择数据库"}.Error()
	}
...
func (a *App) RestoreHiddenPlayerTeam(sourceType string, sourceID int, role string) string {
	if model.Conn == nil {
		return global.Response{Message: "请先选择数据库"}.Error()
	}
...
func (a *App) GetHiddenPlayerTeams() string {
	if model.Conn == nil {
		return global.Response{Message: "请先选择数据库"}.Error()
	}
